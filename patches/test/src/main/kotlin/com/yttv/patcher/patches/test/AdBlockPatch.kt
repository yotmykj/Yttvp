...
class AdBlockPatch : Patch {
    override val id: String = "AdBlockPatch"
    override val name: String = "Ad Block"
    override val description: String = "Blocks advertisements in YouTube TV."
