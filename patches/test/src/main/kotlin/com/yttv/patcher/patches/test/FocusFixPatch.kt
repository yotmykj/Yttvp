...
class FocusFixPatch : Patch {
    override val id: String = "FocusFixPatch"
    override val name: String = "Focus Fix"
    override val description: String = "Fixes focus navigation issues on TV interfaces."
